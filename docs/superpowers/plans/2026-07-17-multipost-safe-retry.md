...
**Interfaces:**
- Consumes: Base token `S5gabIRksaJNRmsmGR3cDUNBnTf`, table `tblT9sUa526I6OYf`
...
```powershell
lark-cli base +field-get --base-token S5gabIRksaJNRmsmGR3cDUNBnTf --table-id tblT9sUa526I6OYf --field-id fldRxw2qkI --as user
lark-cli base +record-get --base-token S5gabIRksaJNRmsmGR3cDUNBnTf --table-id tblT9sUa526I6OYf --record-id recvpCDSGTWH4k --as user
```
