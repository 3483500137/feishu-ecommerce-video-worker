...
$workerTaskName = 'FeishuAccountClonerWorker'
$controllerTaskName = 'FeishuAccountClonerWorkerController'
$legacyTaskNames = @('FeishuEcommerceVideoWorker', 'FeishuEcommerceVideoWorkerController')
